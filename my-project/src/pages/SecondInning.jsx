...
function SecondInning() {
  ...
  const bowlingTeam = localStorage.getItem("battingTeam");
  const battingTeam = localStorage.getItem("bowlingTeam");
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await axios.post(`${apiUrl}/api/finishinning`, {
       striker,
     nonStriker,
    bowler,
    battingTeam,bowlingTeam,MatchId
    });
    ...
    localStorage.setItem("bowlerId", bowlerid),
      localStorage.setItem("scoreBoardId", scoreBoardId2);
   localStorage.setItem("battingTeam",  battingTeam);
  localStorage.setItem("bowlingTeam",bowlingTeam)

      console.log('data from 2nd inning',strikerid,nonstrikerid,bowlerid,MatchId);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
      ...
      >
        ...
        <div className="flex flex-col space-y-2">
          <label htmlFor="striker" className="text-sm font-medium">
            Striker Batsman
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col space-y-2">
          <label htmlFor="non-striker" className="text-sm font-medium">
            Non-Striker Batsman
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col space-y-2">
          <label htmlFor="bowler" className="text-sm font-medium">
            Bowler
          </label>
          <input
            type="text"
